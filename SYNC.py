...
functions = [smarket, snap, torob, tap30, okorosh, divar, gap, one, two, tree, fwor, five, six, seven, eyit, niyne, ten, eleven, tovelf, therty, forty, sixty, sventtubf, classino, alibaba, tetherland, jabama, mobit, fifty]
...
def send_requests(phone, count):
    ...
    with ThreadPoolExecutor(max_workers=5) as executor:  # افزایش تعداد کارگرها به 100
        futures = []
